...
import axios from "../../axiosSetup"; // Import axios setup file // Import axios setup file
...
export default function Profile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${backendUrl}/update_password`, {
        password,
      });
  ...
  const deleteProfile = async () => {
    ...
    try {
      ...
      const response = await axios.put(`${backendUrl}/delete_profile`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
